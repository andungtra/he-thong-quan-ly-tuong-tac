...
public class WikipageHome {
    ...
    public Wikipage merge(Wikipage detachedInstance) {
        ...
        try {
            Wikipage result = (Wikipage) sessionFactory.getCurrentSession()
    ...
    public Wikipage findById( java.lang.Integer id) {
        ...
        try {
            Wikipage instance = (Wikipage) sessionFactory.getCurrentSession()
                    .get("pojo.Wikipage", id);
            if (instance==null) {
    ...
    public List findByExample(Wikipage instance) {
        log.debug("finding Wikipage instance by example");
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("pojo.Wikipage")
