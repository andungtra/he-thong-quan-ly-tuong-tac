...
qq.FileUploaderBasic.prototype = {
	...
	_validateFile : function(file) {
		...
		if (file.value) {
			...
			name = (file.fileName !== null && file.fileName !== undefined) ? file.fileName
					: file.name;
...
qq.UploadDropZone.prototype = {
	...
	_isValidFileDrag : function(e) {
		...
		return dt
				...
				&& (dt.files || (!isSafari && dt.types.contains && dt.types
						.contains('Files')));
		...
		.extend(
				qq.UploadHandlerXhr.prototype,
				{
					...
					getName : function(id) {
						...
						// NOTE: fixed missing name firefox 11.0a2 file.fileName
						// is actually undefined
						return (file.fileName !== null && file.fileName !== undefined) ? file.fileName
								: file.name;
					},
					getSize : function(id) {
						var file = this._files[id];
					...
					_upload : function(id, params) {
						...
						// NOTE: return mime type in xhr works on chrome 16.0.9
						// firefox 11.0a2
