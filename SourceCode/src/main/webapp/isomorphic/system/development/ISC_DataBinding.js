...
/*
  ...
  Version v8.2p_2012-04-30/LGPL Development Only (2012-04-30)
...
);isc.evalBoundary;isc.B.push(isc.A.fetchingClientOnlyData=function isc_DataSource_fetchingClientOnlyData(_1){if(_1.cachingAllData){return false}
...
,isc.A.shouldUseTestDataFetch=function isc_DataSource_shouldUseTestDataFetch(){return this.clientOnly==true&&this.cacheAllData!=true&&(this.dataURL!=null||this.testFileName!=null)}
...
);isc.B._maxIndex=isc.C+174;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.A.$71l={sum:function(_1,_2,_3){var _4=0;for(var i=0;i<_2.length;i++){var _6=_1[_2[i].name],_7=parseFloat(_6);if(isc.isA.Number(_7)&&_7==_6){_4+=_7}else{if(_6!=null&&_6!=isc.emptyString){return null}}}
...
_4.sendTime=isc.timeStamp();_4.changed();_4.callback="isc.RPCManager.performTransactionReply(transactionNum,results,wd)";if(_1)_4.$40c=_1;if(_5.directSubmit){isc.Comm.generateJSCallback(_4);var _15=_5.submitForm;var _16=_15.getForm();if(_15.getItem("_transaction")!=null&&isc.isA.HiddenItem(_15.getItem("_transaction")))
{_15.setValue("_transaction",this.serializeTransaction(_4));this.logInfo("Direct submit assigning request data to hidden field instead of"+" submitting as GET request");_15.setAction(this.addParamsToURL(_3,_9),true)}else{if(_5.useSimpleHttp){_15.setAction(this.addParamsToURL(_3,_9),true);_4.$387=true}else{_15.setAction(this.transactionAsGetRequest(_4,null,_9),true)}}
this.$39a(_4);if(_5.target){if(_5.target!=window)_16.target=_5.target;_15.submitForm()}else{var _17=isc.Comm.getTargetableFrame(_5.prompt);_16.target=_17.getName();_4.$ch=_17;_17.draw(_15.getID()+".submitForm()")}}else if(_5.downloadResult){if(!window.name)window.name=isc.timeStamp();var _18=_4.download_filename;if(_5.downloadToNewWindow==false||(_5.downloadToNewWindow==null&&_5.exportFilename)){var _18=window.name}
if(_5.$38j){this.clearTransaction(_4);_4.transactionRequest=this.transactionAsGetRequest(_4,_3,_9);return _4.transactionRequest}
var _12=isc.addProperties(_9,{_transaction:this.serializeTransaction(_4),protocolVersion:"1.0"});_4.$387=true;this.$39a(_4);_4.$ch=isc.Comm.sendHiddenFrame({URL:_3,httpMethod:_5.httpMethod,httpHeaders:_5.httpHeaders,contentType:_5.contentType,fields:_12,target:_18,transactionNum:_4.transactionNum,transaction:_4})}else{var _12=_9;var _19=_4.transport,_20="send"+(_19.substring(0,1).toUpperCase())+_19.substring(1);if(isc.Comm[_20]==null){this.logWarn("Attempt to send transaction with specified transport '"+_4.transport+"' failed - unsupported transaction type.");return}
this.$39a(_4);var _21;if(_5.isRestRequest){if(_4.operations.length>1){if(_5.contentType==this.$89f){_21="<transaction transactionNum=\""+_4.transactionNum+"\">";_21+="<operations>"
for(var i=0;i<_4.operations.length;i++){if(_4.operations[i].clientOnly)continue;_21+=_4.operations[i].data}
_21+="</operations>";_21+="</transaction>"}else{_21="{ \"transaction\": { \"transactionNum\": "+_4.transactionNum+", ";_21+="\"operations\": [";for(var i=0;i<_4.operations.length;i++){if(_4.operations[i].clientOnly)continue;if(i>0)_21+=", ";_21+=_4.operations[i].data}
_21+="]}}"}}else{_21=_5.data}}else if(_5.useSimpleHttp){_21=_5.data}
isc.RPCManager.$410.push(_4.transactionNum);_4.transactionRequest=isc.Comm[_20]({URL:_3,httpMethod:_5.httpMethod,contentType:_5.contentType,httpHeaders:_5.httpHeaders,bypassCache:_5.bypassCache,data:_21,fields:_12,target:_5.target,callbackParam:_5.callbackParam,transport:_4.transport,blocking:_5.blocking,useSimpleHttp:_5.useSimpleHttp,transactionNum:_4.transactionNum,transaction:_4})}
...
var _3;if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else if(_2.allClientOnly){_2.results={status:0};_2.receiveTime=isc.timeStamp()}else{var _4=_2.results?_2.results.indexOf(this.$381):-1;_3=_4!=-1;if(_3){var _5=_2.results;_5=this.$455(_5);try{_2.results=isc.eval(_5)}catch(e){this.logWarn("Error evaling structured RPC response: "+e+" response text: "+_5)}}else{var _6=_2.operations[0];if(_6&&_6.isRestRequest){var _7=isc.DataSource.get(_6.dataSource);if(_7){if(_6&&_6.dataFormat=="json"&&_7.jsonPrefix==null)
{_3=true}else{var _8=_2.results?_2.results.indexOf(_7.jsonPrefix):-1;_3=_8!=-1}
if(_3){var _9=_2.results;_9=this.$89n(_9,_7);try{_2.results=isc.eval("("+_9+")")}catch(e){this.logWarn("Error evaling REST RPC response: "+e+" response text: "+_9)}}}}}
if(!_3){var _10=isc.isAn.Array(_2.operations)?_2.operations[0]:null;if(_10&&_10.isRestRequest&&_2.operations.length>1){if(_10.dataFormat=="json"){this.logWarn("Found a REST request that appears to be in JSON format, "+"but the response was not wrapped as configured by the jsonPrefix "+"and jsonSuffix properties - aborting")
return}else{_2.results=this.$89g(_2.results);_3=_2.results!=null}}}}
var _11=_2.results;if(_3&&!isc.isAn.Array(_11))_11=[_11];var _12=_2.operations,_13=[];_2.$66n=true;for(var i=0,j=0;i<_12.length;i++){var _6=_12[i];var _16;if(_3&&_6.clientOnly){_16=isc.addProperties(this.createRPCResponse(_2,_6),{isStructured:false})}else{_16=isc.addProperties(this.createRPCResponse(_2,_6),{isStructured:_3,callbackArgs:_2.transport=="scriptInclude"?_11:null,results:_3?_11[j]:_11});if(_3&&_6.isRestRequest){isc.addProperties(_16,{data:_11[j]})}
j++}
if(_16.status==null)_16.status=0;if(_16.isStructured){if(_16.results.errors){var _17=_16.results.errors;if(isc.isAn.Array(_17)&&_17.length==1){_17=_17[0]}}
if(_16.results&&!_6.isRestRequest){if(!_16.results.response){isc.addProperties(_16,_16.results)}else{isc.addProperties(_16,_16.results.response)}}}
_13[i]=_16;_2.responses[i]=_16;_2.changed()}
var _18=0;while(_18<_12.length&&!_2.suspended&&!_2.abortCallbacks)
{var _6=_12[_18],_16=_13[_18];this.performOperationReply(_6,_16);_18++}
if(_2.showPrompt)this.doClearPrompt(_2);if(!_2.suspended&&!_2.abortCallbacks){this.clearTransaction(_1)}
delete _2.abortCallbacks;delete _2.$66n;if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _19=_6.application?_6.application:this.getDefaultApplication();if(isc.isA.String(_19))_19=window[_19];_19.fireCallback(_2.$40c,"responses",[_2.responses])}}
...
);isc.B._maxIndex=isc.C+74;isc.RPCManager.rpc_logMessage=isc.RPCManager.logMessage;isc.RPCManager.logMessage=function(_1,_2,_3,_4){if(this.logIsEnabledFor(_1,_3)){if(isc.isA.String(_2)&&_2.length>this.maxLogMessageLength&&!this.logIsEnabledFor(_1,"RPCManagerResponse"))
...
);isc.B._maxIndex=isc.C+5;isc.defineClass("RulesEngine");isc.A=isc.RulesEngine.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.init=function isc_RulesEngine_init(){this.Super("init",arguments);isc.ClassFactory.addGlobalID(this);if(this.members==null)this.members=[];else{for(var i=0;i<this.members.length;i++){var _2=this.members[i];if(isc.isA.String(_2)){this.members[i]=_2=window[_2]}
this.$889(_2,true)}}}
