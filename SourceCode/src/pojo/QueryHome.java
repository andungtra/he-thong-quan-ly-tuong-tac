...
public class QueryHome {
    ...
    public Query merge(Query detachedInstance) {
        ...
        try {
            Query result = (Query) sessionFactory.getCurrentSession()
    ...
    public Query findById( java.lang.Integer id) {
        log.debug("getting Query instance with id: " + id);
        try {
            Query instance = (Query) sessionFactory.getCurrentSession()
                    .get("pojo.Query", id);
            if (instance==null) {
